  ...
  const Projects = ref([
    {
      ...
      image: "/assets/captureandcall.jpg",
      ...
      technologies: [".NET MVC", "C#", "PostgreSQL"],
      gitURL: "#",
      webURL: "#",
    },
    {
    ...
    },
    {
      id: 3,
      category: "web development",
      image: "/assets/tinisoftappspage.jpg",
