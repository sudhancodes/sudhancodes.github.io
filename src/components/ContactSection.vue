          ...
          <div>
            ...
            <div class="flex mb-6 items-center">
              ...
              <div class="ml-5 text-white">
                ...
                <p>
                  <a
                    href="mailto:sudhansasikumar22@gmail.com"
                    class="text-blue-400 hover:underline"
                    >sudhansasikumar22@gmail.com</a
                  >
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div class="flex mb-6 items-center">
              ...
              <div class="ml-5 text-white">
                ...
                <p>
                  <a
                    href="https://www.linkedin.com/in/sudhansasi22"
                    target="_blank"
                    class="text-blue-400 hover:underline"
                    >linkedin.com/in/sudhansasi22</a
                  >
                </p>
              </div>
            </div>
            ...
            <div class="flex mb-6 items-center">
              <div
                ...
                style="background: #111a3e; width: 50px; height: 46px; display: flex; justify-content: center; border-radius: 50%;
                overflow: hidden; border: 1px solid #111a3e; backdrop-filter: blur(9px); -webkit-backdrop-filter: blur(9px);">
                <img src="https://img.icons8.com/ios-filled/50/ffffff/github.png" alt="github" class="w-6">
              </div>
              <div class="ml-5 text-white">
                <h4>GitHub</h4>
                <p>
