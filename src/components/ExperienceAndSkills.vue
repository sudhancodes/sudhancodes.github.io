...
const Skills = ref([
    ...
    { id: 2, name: 'Java', icon: 'https://img.icons8.com/ios-filled/50/ffffff/java-coffee-cup-logo.png', level: '85%', proficiency: 'Advanced' },
    { id: 3, name: 'HTML & CSS', icon: 'https://img.icons8.com/ios-filled/50/ffffff/html-5.png', level: '95%', proficiency: 'Expert' },
    { id: 4, name: 'JavaScript', icon: 'https://img.icons8.com/ios-filled/50/ffffff/javascript-logo.png', level: '90%', proficiency: 'Advanced' },
    { id: 5, name: 'ASP.NET MVC', icon: 'https://img.icons8.com/ios-filled/50/ffffff/microsoft.png', level: '80%', proficiency: 'Intermediate' },
    { id: 6, name: 'PostgreSQL', icon: 'https://img.icons8.com/ios-filled/50/ffffff/database.png', level: '75%', proficiency: 'Intermediate' },
    { id: 7, name: 'Vue.js', icon: 'https://img.icons8.com/ios-filled/50/ffffff/vue-js.png', level: '70%', proficiency: 'Intermediate' },
]);
...
const Experiences = ref([
    ...
    },
    {
        ...
        icon: 'https://img.icons8.com/ios-filled/50/ffffff/web-development.png',
    },
]);
</script>
