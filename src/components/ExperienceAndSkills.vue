<template>
    <section class="text-white mt-18" id="skills">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-start py-8 px-4 xl:gap-16 xl:px-16">
    <!-- Skills Section -->
    <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full w-full">
        <h2 class="text-4xl font-bold text-white text-center md:text-left mb-4">My Skills</h2>
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div v-for="skill in Skills" :key="skill.id" class="flex items-center space-x-4" data-aos="fade-right">
                <div class="w-12 h-12 flex justify-center items-center rounded-full bg-[#1f1641]">
                ...
                <div class="w-full">
                    ...
                    <p class="text-sm text-white mt-1">{{ skill.proficiency }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Experiences Section -->
    <div data-aos="flip-left" class="mt-16 md:mt-0">
        <h2 class="text-4xl font-bold text-white text-center md:text-left mb-8 md:mt-0 mt-8">My Experiences</h2>
        <div class="space-y-8 py-8" data-aos="fade-left">
            <div v-for="element in Experiences" :key="element.id" class="flex items-center rounded-xl p-4 bg-[#111a3e] shadow-lg border border-[#1f1641] min-h-[120px]">
                <div class="w-1/4 flex justify-center items-center">
                    <img :src="element.icon" alt="Experience Icon" class="w-12 h-12" />
                </div>
                <div class="w-3/4 pl-4">
                    <h3 class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary role-text">
                        {{ element.role }}
                    </h3>
...
const Skills = ref([
    ...
    { id: 3, name: 'Vue.js', icon: 'https://img.icons8.com/ios-filled/50/ffffff/vue.js', level: '70%', proficiency: 'Intermediate' },
    ...
    { id: 8, name: 'VS Code', icon: 'https://img.icons8.com/ios-filled/50/ffffff/visual-studio-code.png', level: '85%', proficiency: 'Advanced' },
]);
...
const Experiences = ref([
    {
        ...
        company: 'TINISOFT Technologies',
        date: 'August 2024 - January 2025',
        icon: 'https://img.icons8.com/ios-filled/50/ffffff/internship.png',
    },
    {
        id: 2,
